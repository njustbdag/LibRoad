...
public class PackagePairCandidate {
    ...
    public PackagePairCandidate(LibPackageProfile libPackage, Collection<ApkPackageProfile> apkPackages,Map<String, Integer> set) {
        ...
        for (ApkPackageProfile apkPackage : apkPackages) {
        	if(!set.containsKey(apkPackage.packageName)){
    ...
    private void matchClassHashPercent(ApkPackageProfile apkPackageProfile) {
        ...
        if (LibPeckerConfig.DEBUG_LIBPECKER&&weightedSimilarity!=0) {
    ...
    public double getMaxSimilarity() {
        ...
        //System.out.println("candiApkPackageSimilarity"+ candiApkPackageSimilarity.size());
