...
public class ClassProfile implements ProfileSignature, SimpleClassProfile {
    ...
    @Override
    public String getMethoddescriptorHashList() {
    	StringBuilder MethoddescriptorHashList = new StringBuilder();
        	//ArrayList<String> MethoddescriptorHashList = new ArrayList<>();
        	synchronized (this) {
                methodHashList = new ArrayList<>();
            for (MethodProfile methodProfile : staticMethodProfiles) {
            	MethoddescriptorHashList.append(HashHelper.hash(methodProfile.descriptor()));
            }
            for (MethodProfile methodProfile : instanceMethodProfiles) {
            	MethoddescriptorHashList.append(HashHelper.hash(methodProfile.descriptor()));
            }

            return MethoddescriptorHashList.toString();
        	}
    }
