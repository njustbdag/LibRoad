...
/**
 * LibClassInfo entity. @author MyEclipse Persistence Tools
 */

public class LibClassInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public LibClassInfo(String libClassname) {
		this.libClassname = libClassname;
	}

	/** full constructor */
	public LibClassInfo(String libClassname, String classHashStrict,
